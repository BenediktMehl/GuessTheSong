...
declare namespace Spotify {
  interface Player {
    ...
    // biome-ignore lint/complexity/noBannedTypes: Spotify SDK requires Function type
  ...
  interface PlaybackState {
    context: {
      uri: string | null;
      // biome-ignore lint/suspicious/noExplicitAny: Spotify SDK metadata type is unknown
      metadata: any;
    };
    disallows: {
      pausing?: boolean;
